...
| Vedlegg | Fil | Formål |
|---|---|---|
| Forretningsplan v1.0 | `forretningsplan/fg30_forretningsplan.md` (.docx finnes) | Konsept, marked, økonomi (oppdaterte tall fra T93) |
...
| Finansieringsplan | `leveranser/2026-06-28_fg30_finansieringsplan.md` | Total kapitalbehov, EK-sammensetning inkl. støtte |

**Avhengighet:** Finansieringsplan-dokumentet er ferdigstilt i [T99](#t99) – `leveranser/2026-06-28_fg30_finansieringsplan.md`.

**Leveranse:** `leveranser/2026-06-28_fg30_bankhenvendelse.md` (Pandoc-klar, kan konverteres til .docx eller limes inn i e-postklient)
...
**Relevante filer:**
- `forretningsplan/fg30_forretningsplan.md` – seksjoner 3.2, 4.1, 5.2, 6.3, 7.1, 9
- `forretningsplan/kilde_markedsdata.md` – seksjon 3 (prisspenn) bør reflektere ny forståelse
...
- Også oppdatert: `forretningsplan/kilde_markedsdata.md` seksjon 3 FG30-rad (220/265 → 300/360)

---

### T95 `[ ]` Utbetalingsanmodning – Stiftelsen UNI
**Mottaker:** Stiftelsen UNI (100 000 kr, ref UNI-38702)

Tilskuddet gjelder brannsikring. Utbetaling krever revisor/regnskapsfører-bekreftelse og anmodes via søknadsportalen («Be om utbetaling»). Arbeidsrapporten (T01) er levert og brukes som vedlegg.

---

### T97 `[ ]` Framdriftsrapport / utbetalingsanmodning – Enova Energikartlegging
**Mottaker:** Enova (saksnr. 26/2548, 400 000 kr, 50% intensitet)

Støtteordning for energikartlegging gjennomført av HRP/RiEn. Les `../stotte`-prosjektet og `stotte/project_cards.json` for krav til framdriftsrapportering og utbetaling. Rapport fra HRP er levert (se `bakgrunn/stotte/enova_kl/hrp_energikartlegging_rapport.md`).

---

### T98 `[ ]` Framdriftsrapport / utbetalingsanmodning – Enova Ombrukskartlegging
**Mottaker:** Enova (saksnr. 26/2555, 500 000 kr, 50% intensitet)

Støtteordning for ombrukskartlegging gjennomført av HRP. Les `../stotte`-prosjektet og `stotte/project_cards.json` for krav til framdriftsrapportering og utbetaling. Avklar med HRP om kartleggingen er ferdig – se også T22 (søknad om utsettelse dersom prosjektperioden utløper).
...
3. **Tilskudd som EK-komponent – juridisk forankring** – pek på allerede produsert grunnarbeid:
   ...
   - `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` (innvilget-oversikt)
...
**Relevante filer:**
- `forretningsplan/fg30_forretningsplan.md` seksjon 6.1 (kostnadsanslag), seksjon 8 (lønnsomhet)
- `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md`
- `leveranser/2026-06-26_tilskudd_som_egenkapital.md`
- `leveranser/2026-06-26_groenne_laan_kriterier.md`
- `stotte/project_cards.json` (status per støtteprosjekt)

**Avhengighet for T90:** Skal være ferdig før bankhenvendelsen sendes ut.

**Leveranse:** `leveranser/2026-06-28_fg30_finansieringsplan.md` (Pandoc-klar, kan konverteres til .docx)
...
1. **Grønt lån** – kriteriene er beskrevet i `leveranser/2026-06-26_groenne_laan_kriterier.md`, men ikke nevnt i selve planen.
...
**Relevante filer:**
- `forretningsplan/fg30_forretningsplan.md` (selve planen – endres)
- `forretningsplan/kilde_markedsdata.md` (sjekk for konsistens)
- `leveranser/2026-06-26_groenne_laan_kriterier.md` (kildemateriale)
- `leveranser/2026-06-26_tilskudd_som_egenkapital.md` (kildemateriale)
- `bakgrunn/stotte/enova_kl/hrp_energikartlegging_rapport.md` (kildemateriale)
- `leveranser/2026-06-28_fg30_finansieringsplan.md` (T99-output)

**Leveranse:** Oppdatert `forretningsplan/fg30_forretningsplan.md` (v1.1) + ev. tilhørende `.docx` regenerert med Pandoc.
...
| Dokument | Endring |
|---|---|
| `forretningsplan/fg30_forretningsplan.md` seksjon 4.1 | Fjern interne task-referanser «T91/T92, 26.06.2026» (to forekomster, linje 174 og 219). Behold faktainnholdet men formuler om kildehenvisningen til generelle termer (f.eks. «verifisert mot konkurrentens prisliste juni 2026») |
| `leveranser/2026-06-26_groenne_laan_kriterier.md` siste linje (linje 244) | Fjern sluttbemerkning som refererer til T89 og T24 («Dette dokumentet er utarbeidet som faglig grunnlag for T89 ... og T24 ...»). Behold ev. metakommentar uten task-numre |
| `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` linje 141 og 221 | Fjern interne paths «`bakgrunn/lovverk/tilskudd_som_egenkapital.md`». Henvis til «separat vedlegg» i stedet |
| `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` linje 227 | Fjern referanse til «`stotte/2026-06-22_fg30_stoetteoversikt_bank.md`» (banken trenger ikke vite at det fantes et tidligere utkast) |
| `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` seksjon 7 | Rydd «Tilstandsanalyse – HRP AS» og «project_cards.json» – disse er ikke i bankpakken. Behold tilsagnsbrev, utbetalingsbekreftelser, rammesøknad og rapport som «kan fremlegges på forespørsel» |
...
|---|---|
| MVA-strategi og juridisk analyse – utfyllende notat | `forretningsplan/fg30_vurderinger_mva.md` |
| Konkurrentanalyse og markedsdata | `forretningsplan/kilde_markedsdata.md` |
...
| Fil | Endring |
|---|---|
| `forretningsplan/fg30_vurderinger_mva.md` linje 230 | Fjern interne paths `stotte/fg30_skattefunn_vurdering.md` og `stotte/fg30_innovasjon_norge_vurdering.md`. Behold faginnholdet, fjern bare path-henvisningen |
| `forretningsplan/kilde_markedsdata.md` linje 3 | Fjern «(T91)» fra «Oppdatert med prisdata 26. juni 2026 (T91)» |
...
| Dokument | Endring |
|---|---|
| `forretningsplan/fg30_forretningsplan.md` slutten (vedleggsliste) | Listen «kan fremlegges på forespørsel» skal nå reflektere at alle tre er vedlagt (sammen med finansieringsplan og energirapport). Enten omformuler til «Vedlagt:» eller fjern listen helt (siden bankhenvendelsen-coverbrevet uansett lister alle vedleggene) |
| `leveranser/2026-06-28_fg30_bankhenvendelse.md` vedleggstabell | Utvid med 3 nye rader for MVA-strategi, konkurrentanalyse/markedsdata, lovhenvisninger. Hvis arbeidsrapport droppes (se nedenfor), fjernes den raden |
| `leveranser/2026-06-28_fg30_bankhenvendelse.md` seksjon 5 | Hvis arbeidsrapport droppes: tilpass punktet «Fysisk forberedende arbeid pågår – dokumentert i egen arbeidsrapport» til «Fysisk forberedende arbeid pågår – nærmere dokumentasjon kan fremlegges på forespørsel» |
...
- `forretningsplan/fg30_forretningsplan.md` (T91/T92 fjernet i seksjon 4.1; vedleggsliste på slutten endret fra «kan fremlegges på forespørsel» til «Vedlagt»)
- `forretningsplan/fg30_vurderinger_mva.md` (linje 230: SkatteFunn/IN-paths fjernet)
- `forretningsplan/kilde_markedsdata.md` (linje 3: «(T91)» fjernet)
- `forretningsplan/kilde_mva_regelverk.md` (ingen endringer nødvendig)
- `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` (linje 141: path erstattet med «separat vedlegg»; seksjon 7 ryddet for path og uvedlagte filer (Tilstandsanalyse, project_cards.json); sluttbemerkning ryddet for utkast-referanse)
- `leveranser/2026-06-26_groenne_laan_kriterier.md` (sluttbemerkning: T89/T24-referanse fjernet)
...
Observasjon for senere oppfølging: `forretningsplan/fg30_vurderinger_mva.md` linje 10 sier «20–35 MNOK i byggekostnader». Inkonsistent med forretningsplanens 30 MNOK basisflate. Ikke en intern referanse – kan rettes ved neste revisjon av notatet.

#### Lav prioritet

| Dokument | Endring |
|---|---|
| `bakgrunn/stotte/enova_kl/hrp_energikartlegging_rapport.md` | Kontrolleres i sin helhet for interne referanser – kun første 100 linjer av 30-siders rapport er gjennomgått i T90/T102-analysen |
...
| Dokument | Hva |
|---|---|
| `forretningsplan/kilde_markedsdata.md` | Linje 233 (kajakk-referansen 204 kvm) + ev. andre areal-referanser |
| `forretningsplan/fg30_vurderinger_mva.md` | Hvis areal nevnes i kvantifisering – sjekk |
...
| 02 | `leveranser/2026-06-28_fg30_finansieringsplan.md` |
| 03 | `forretningsplan/fg30_vurderinger_mva.md` |
| 04 | `forretningsplan/kilde_markedsdata.md` |
| 05 | `leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` |
| 06 | `leveranser/2026-06-26_tilskudd_som_egenkapital.md` |
| 07 | `leveranser/2026-06-26_groenne_laan_kriterier.md` |
| 08 | `bakgrunn/stotte/enova_kl/hrp_energikartlegging_rapport.md` |
...
**KMF/BYA-overbevisning** (`leveranser/2026-06-26_fg30_stoetteoversikt_bank.md` kap. 3.1 og 3.2):
...
2. **Markedsabsorpsjon bottom-up Trondheim — ikke utført i denne tasken.** Forretningsplanens kap. 3.1 og `forretningsplan/kilde_markedsdata.md` har allerede markedsdata fra konkurrentanalysen (T91/T92) og nasjonale benchmark. I tråd med prinsippet «vi presenterer data, banken gjør sine egne analyser» utvides ikke markedsdokumentasjonen utover dette.

3. **LOI-kampanje — lagt som ny task T110.** Skal igangsettes senere, nærmere byggestart.

**Oppdaterte dokumenter:**

- `forretningsplan/fg30_forretningsplan.md` — 8.1 NPV-tabell + fotnote (cap rate 7,5 / 7,0 / 6,5 %; verdi 30,0 / 36,1 / 43,8 MNOK; LTV ~80 % i fotnote); 6.1 finansieringstabell (LTV-rad 36 MNOK / ~80 %)
- `leveranser/2026-06-28_fg30_finansieringsplan.md` — sammendrag (LTV 83 → 97 % basis, 69 → 80 % forventet, 55 → 64 % maks); 2.5 eiendomsverdi (cap rate 7,0 %; 36 MNOK); 4.2 LTV-tabell + fortolkning; 7.1 tilskuddsutfall (LTV-rader); 7.2 BFU-utfall (LTV-rader 76–97 %); 7.5 worst case cap rate 8,0 → 9,0 %, verdi 13,1 → 11,7 MNOK, LTV 69 → 80 %; «kombinert moderat stress» LTV 75 → 88 %
- `leveranser/2026-06-28_fg30_bankhenvendelse.md` — faktaboks (~42 MNOK / ~69 % → ~36 MNOK / ~80 %); sentrale tall (eiendomsverdi base)
- Regenerert: `bank/00`, `bank/01`, `bank/02`
...
### T109 `[ ]` ESG-supplement: DNSH, klimatilpasning, energiattest-verifikasjon

**Bakgrunn:** ESG-agent (T104) flagget flere svakheter i grønt lån-pakka. Brukeren har stilt berettiget spørsmål ved to av anbefalingene, så tasken starter med verifikasjon før handling.

#### Steg 1: Verifiser HRP-rapport mot DNBs konkrete dokumentasjonskrav

Brukerens vurdering: HRP-rapporten er bunnsolid og i tråd med Enova-kravene. ESG-agentens innvending: DNB V.5.1 krever en formell «energiattest» (energimerking.no) som er separat fra en «energikartlegging».

**Handling:** Sjekk DNBs faktiske dokumentasjonskrav (V.5.1, februar 2026) — er HRPs energirapport tilstrekkelig, eller kreves en separat energimerking? HRP er sannsynligvis akkreditert energirådgiver og kan utstede begge — i så fall kan en formell attest bestilles som tillegg uten ny analyse.

**Hvis HRP-rapport ER tilstrekkelig:** Avbryt energiattest-action. Forbedring blir bare en kort tilleggsetning i 07 Grønt lån som adresserer dokumentasjonskravet eksplisitt.

**Hvis formell attest kreves:** Bestill fra HRP (forventer minimal kostnad).

#### Steg 2: Verifiser 53 %-beregningsbasen mot DNBs ordlyd

Brukerens vurdering: HRP-rapport er solid; problemet er sannsynligvis bare hvordan grønt lån-vedlegget vårt siterer rapporten.

**Faktum:** HRP-rapport viser begge tallene — nå-tilstand 252 000 kWh (256 kWh/m², energimerke G) og referansebygg 427 000 kWh. T1-pakkens 53 % er beregnet mot referansebygget. DNBs V.5.1 krever besparelse mot «byggets opprinnelige energiytelse».

**Handling:** Oppdater 07 Grønt lån sin tabell og prosa til å vise både (a) reduksjonen mot byggets opprinnelige ytelse (kWh/m²) og (b) reduksjonen mot referansebygget. Sannsynligvis tilfredsstilles begge — det er en presentasjons-fiks, ikke ny analyse.

Hvis det viser seg at HRP ikke har den ene beregningen — bestill kort tilleggsnote fra HRP (estimert 1–2 timers konsulent-tid).

#### Steg 3: DNSH-vedlegg for taksonomi 7.2

Lag et kort vedlegg (1–2 sider) som operasjonaliserer Do No Significant Harm-kravet i EU-taksonomien art. 7.2 for alle seks miljømål:
- Klimagassreduksjon: dekket av T1-pakken (allerede dokumentert)
- Klimatilpasning: bryggebygg på Nidelvas bredd — kort vurdering mot NVE-flomkart og havnivåprognoser
- Vann: avløp, byggefase-utslipp
- Sirkulær økonomi: kobles til Enova ombrukskartlegging (500 000 kr innvilget — ubrukt narrativ)
- Biologisk mangfold: bygget innenfor eksisterende fotavtrykk, ingen ny eksponering
- Forurensning: materialvalg, asbestkartlegging, vernemaling

#### Steg 4: Klimatilpasning eksplisitt i forretningsplan

Legg til kort avsnitt i kap. 9 risikovurdering om flomrisiko (Nidelv-bredd) og hvordan bygget er sikret historisk + ev. nye tiltak.

#### Steg 5: Sirkulær økonomi-narrativ

Knytt Enova ombrukskartlegging eksplisitt til ESG-historien i forretningsplan og bankhenvendelse. Originalt laftet treverk gjenbrukes — kvantifiser klimanytte hvis mulig.

#### Berørte filer

- 07 Grønt lån (oppdatert 53 %-fremstilling, oppdatert DNB-krav-tabell)
- 01 Forretningsplan (kap. 2.4 sirkulær økonomi, kap. 9 klimatilpasning)
- 00 Bankhenvendelse (kort omtale av sirkulær økonomi)
- Nytt vedlegg: DNSH-vurdering (ev. egen .md-fil)

**Estimat:** 2–3 timer + ev. ekstern HRP-konsultasjon hvis steg 1 eller 2 krever det.

**Leveranse:** Verifikasjon av HRP-status + oppdaterte md/docx + nytt DNSH-vedlegg.

**Status per 29.06.2026:** Forarbeid gjennomført, men selve tasken er ikke løst.

#### Gjort

Steg 1+2 verifisering av HRP-rapporten mot DNB V.5.1 gjennomført. Identifisert 6 gap til bestilling fra HRP:

1. **Reduksjonstallene 53 % vs. 34 % og arealspørsmålet.** 53 % er mot referansebygg (427 000 kWh, 2 655 m² brutto). 34 % i HRPs avsnitt 5.3.1 er mot opprinnelig ytelse. Bygget endrer karakter: i dag er kun ~1 000 m² i aktiv bruk (252 000 kWh / 256 kWh/m² ≈ 984 m²), etter rehabilitering vil hele 2 655 m² være i drift. Per aktivt brukt kvm er reduksjonen ~71 % (256 → 75 kWh/m²). Tilbakemeldingen ber HRP presentere reduksjonen i flere basiser slik at banken kan velge.
2. **Energiattest – uavklart.** Det er ikke entydig om DNB krever formell registrering på energimerking.no eller om HRP-rapporten + skriftlig sertifiseringsbekreftelse er tilstrekkelig. Tilbakemeldingen ber HRP avklare.
3. **Solceller (avsnitt 4.13) – kategorisk lønnsomhetskonklusjon uten faglig grunnlag.** Beregnet i Simien (bygningsenergisimulator), ikke PVsyst (solcelle-standard). Snølagstap overdrevet. Mangler spart nettleie, batteripotensial og fremtidig prisutvikling fra NO1/NO5-kabelutbygging mot NO3. Tilbakemeldingen ber HRP omskrive 4.13 til faktabasert framstilling og prise PVsyst-simulering hvis aktuelt.
4. **PED-bekreftelse (EU-taksonomi art. 7.2)** mangler eksplisitt.
5. **Komplettsfremstillings-tabell mot DNB-/EU-krav** er ikke i rapporten – ønsket utvidet med flere reduksjonsbasiser.
6. **Akkrediteringstekst** for HRP / Anne Kristine Amble mangler.

**Leveranse:** `leveranser/2026-06-29_fg30_tilbakemelding_hrp_energirapport.md` (+ .docx) – tilbakemelding til HRP med konkret bestilling. Ber om komplettering innen 2 uker.

**Interim-implementering 29.06.2026 (for å sende bankpakka uten å vente på HRP):**

Vi binder oss ikke til en HRP-versjon som ikke finnes. I stedet er bildet vi mener er korrekt bygget inn i vårt eget grønt lån-vedlegg:

- `leveranser/2026-06-26_groenne_laan_kriterier.md`: sammendragstabell utvidet (53 % / 34 %), 1.3-tabell omdøpt til «mot referansebygg» med 34 %-tall i prosa, ny seksjon 1.4 «Beregningsbasis og bygget i delvis bruk i dag» med utdypning av areal-betraktning og overgang fra delvis til full drift, 6.1-tabell utvidet med flere reduksjonsbasiser
- `leveranser/2026-06-28_fg30_bankhenvendelse.md` seksjon 3: 53 %/34 %-tall begge nevnt + areal-betraktning + note om at HRP-presentasjons-versjon ettersendes (kjernekonklusjon uendret)
- `forretningsplan/fg30_forretningsplan.md` 2.4: T1-prosa utvidet med begge basiser, kvalifikasjonstabell utvidet med rad for «opprinnelig ytelse»

Original HRP-rapport (PDF) legges av Eirik som `bank/08_energikartleggingsrapport.pdf` (erstatter dagens .docx som er Pandoc-konvertering av et md-ekstrakt). Docx-versjoner av bank-vedleggene er ikke regenerert i denne sesjonen – bestilles av Eirik ved utsending.

#### Avventer ekstern handling

- Tilbakemeldingen må sendes fra Eirik til Anne Kristine (HRP)
- HRP-respons (anmodet innen 2 uker)
- Når svar foreligger: oppdatere `leveranser/2026-06-26_groenne_laan_kriterier.md`, forretningsplan kap. 2.4 og bankhenvendelse 00 med korrekte tall og presentasjonsform

#### Ikke startet

- Steg 3 – DNSH-vedlegg for taksonomi 7.2 (andre miljømål: klimatilpasning, vann, sirkulær økonomi, biologisk mangfold, forurensning)
- Steg 4 – klimatilpasning eksplisitt i forretningsplan kap. 9 risikovurdering (flom/Nidelv)
- Steg 5 – sirkulær økonomi-narrativ (kobling til Enova ombrukskartlegging i forretningsplan + bankhenvendelse)

Tasken settes uløst (`[ ]`) inntil HRP-svaret er implementert og steg 3–5 er gjennomført. Steg 3–5 kan tas uavhengig av HRP-svaret; vurder om de skal splittes ut til egne tasks.

---

### T110 `[ ]` LOI-/pre-booking-kampanje for forhåndskunder

**Bakgrunn:** Letters of intent fra interessenter (særlig båt-/padle-segmentet for krypkjellerkonseptet og næringskunder for selvbetjent + full-service) styrker bankens belegg-antakelse markant før byggestart. Tasken er flyttet ut av T108 og settes opp som egen leveranse nærmere byggestart.

**Mål:** Samle 5–10 ikke-bindende LOI fra interessenter som signaliserer betalingsvillighet og kobler reelle navn til prosjektet.

**Forventet leveranse:**

- Pre-booking-side eller skjema (web eller PDF) med kort presentasjon av konseptet og indikative priser fra T93 (300 kr/kvm/mnd selvbetjent, 360 kr/kvm/mnd full-service ved launch)
- LOI-mal (ikke-bindende interesseuttalelse) som kan signeres digitalt
- Målrettet utsendings-/markedsføringsplan: båtforening, padleklubb, Adresseavisen, Facebook, lokale næringsnettverk
- Oppfølgings-løype

**Avhengighet:** Bør igangsettes nærmere byggestart (Q3–Q4 2026) når rammesøknad er besvart og IG-arbeidet er i gang. Tidlig kjøring gir lengre commitment-vindu og økt risiko for at interessenter faller fra; for sen kjøring rekker ikke materialet å påvirke bankdialog.

**Strategisk bruk:** LOI-bilag legges som tilleggsdokumentasjon til bankhenvendelsen og kan også brukes i tilskuddssøknader (særlig Enova Energioppgradering og fylkeskommunale ordninger).
